  ...
  <header class="header" :class="{ 'header--scrolled': isScrolled }">
    <div class="container header__inner">
      ...
      <nav class="nav" :class="{ 'nav--open': isBurgerOpen }">
        ...
        <NuxtLink to="#stages" class="nav__link" @click="closeMobile">Этапы</NuxtLink>
        <NuxtLink to="#videos" class="nav__link" @click="closeMobile">Подкасты</NuxtLink>
        <NuxtLink to="#portfolio" class="nav__link" @click="closeMobile">Работы</NuxtLink>
        <NuxtLink to="#about" class="nav__link" @click="closeMobile">О нас</NuxtLink>
      ...
      <div class="header__right">
        ...
        <button class="theme-toggle" aria-label="Переключить тему" @click="toggle">
